...
// Bootstrap 4, FontAwesome, Chart.js y librerías necesarias
...
app.use('/stylesheets', express.static(__dirname + '/node_modules/@fortawesome/fontawesome-free/webfonts'));
...
app.use('/javascripts', express.static(__dirname + '/node_modules/moment/min'));
